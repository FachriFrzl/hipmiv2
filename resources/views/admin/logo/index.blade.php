    ...
    <div class="row">
      ...
      <div class="col-md-12">
        ...
        <div class="card card-primary">
          ...
          <!-- /.card-header -->
          <!-- form start -->
          <form action="{{ route('admin.logo.update',$settinglogo->id) }}" role="form" id="updateform" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="card-body">
              @if($settinglogo->logo)
              ...
              <div class="col-md-4"><a href="/admin/logo" class="btn btn-sm btn-danger">Hapus</a></div><br>
              @else @endif
