@extends('layouts.app', ['title' => 'Tambah About - Admin'])
        ...
        <div class="p-6 bg-white rounded-md shadow-md">
            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-6 mt-4">
                    ...
                    <div>
                        <label class="text-gray-700" for="name">About</label>
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text" name="about" value="" placeholder="About Us">
                            <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                <div class="px-4 py-2">
                                    <p class="text-gray-600 text-sm"></p>
                                </div>
