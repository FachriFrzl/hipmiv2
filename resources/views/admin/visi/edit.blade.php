        ...
        <div class="p-6 bg-white rounded-md shadow-md">
            ...
            <form action="{{ route('admin.visi.update', $visi->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                        ...
                        <div class="col-sm-5">
                            <img src="{{asset('storage/visi/'.$visi->gambar)}}" class="admin-edit-image">
                        </div>
                    ...
                    <div>
                        ...
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text" name="visi" value="{{ old('visi', $visi->visi) }}" placeholder="Visi">
                        @error('visi')
