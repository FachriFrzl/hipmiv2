            ...
            <form action="{{ route('admin.slider.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-6 mt-4">
                    <div>
                        ...
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text" name="title" value="{{ old('title') }}" placeholder="Judul Slide">
                        @error('title')
                    ...
                    <div>
                        <label class="text-gray-700" for="name">BUTTON TEXT</label>
                        <input class="form-input w-full mt-2 rounded-md bg-gray-200 focus:bg-white" type="text" name="button" value="{{ old('button') }}" placeholder="Button Text">
                        @error('button')
                            <div class="w-full bg-red-200 shadow-sm rounded-md overflow-hidden mt-2">
                                <div class="px-4 py-2">
                                    <p class="text-gray-600 text-sm">{{ $message }}</p>
                        ...
                        @forelse($sliders as $slider)
                            <tr class="border bg-white">
                                ...
                                <td class="px-16 py-2 flex justify-center">
                                    <img src="{{asset('/storage/sliders/'.$slider->image)}}" class="object-fit-cover rounded" style="width: 100%">
                                </td>
                                <td class="px-16 py-2">
                                    <h5><b>{{ $slider->title }}</b><h5>
